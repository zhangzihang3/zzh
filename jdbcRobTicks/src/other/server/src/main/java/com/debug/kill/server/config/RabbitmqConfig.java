...
public class RabbitmqConfig {
    ...
    public Queue successEmailQueue(){
        return new Queue(env.getProperty("mq.kill.item.success.email.BlockingQueue"),true);
    }
    ...
    public Queue successKillDeadQueue(){
        ...
        return new Queue(env.getProperty("mq.kill.item.success.kill.dead.BlockingQueue"),true,false,false,argsMap);
    }
    ...
    public Queue successKillRealQueue(){
        return new Queue(env.getProperty("mq.kill.item.success.kill.dead.real.BlockingQueue"),true);
    }
    ...
    public Queue executeLimitQueue(){
        ...
        return new Queue(env.getProperty("mq.kill.item.execute.limit.BlockingQueue.name"),true,false,false,argsMap);
    }

    @Bean
    public TopicExchange executeLimitExchange(){
        return new TopicExchange(env.getProperty("mq.kill.item.execute.limit.BlockingQueue.exchange"),true,false);
    }

    @Bean
    public Binding executeLimitBinding(){
        return BindingBuilder.bind(executeLimitQueue()).to(executeLimitExchange()).with(env.getProperty("mq.kill.item.execute.limit.BlockingQueue.routing.key"));
    }
}
