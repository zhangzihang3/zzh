...
public class RabbitReceiverService {
     ...
     * 秒杀异步邮件通知-接收消息
     */
    @RabbitListener(queues = {"${mq.kill.item.success.email.BlockingQueue}"},containerFactory = "singleListenerContainer")
     ...
     * @param info
     */
    @RabbitListener(queues = {"${mq.kill.item.success.kill.dead.real.BlockingQueue}"},containerFactory = "singleListenerContainer")
     ...
     * @param dto
     */
    @RabbitListener(queues = {"${mq.kill.item.execute.limit.BlockingQueue.name}"},containerFactory = "multiListenerContainer")
